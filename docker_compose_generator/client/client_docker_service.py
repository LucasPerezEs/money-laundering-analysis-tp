...
def get_client_docker_services(input_file_path, output_file_path, total_clients):
    # Open config file
    ...
    for i in range(total_clients):
        ...
        # Add container name
        new_client_service_config[CONTAINER_NAME_TAG] = f"{CLIENT_NAME_PREFIX}_{i}"
        ...
        # Add service
        new_clients_services.append(new_client_service_config)
